...
patt = /[0-9]/g;  //0~9까지의 숫자중에서 일치하는 숫자를 찾음
result = str.match(patt);  //str에서 patt패턴과 일치하는 부분을 찾아 배열로 반환
console.log(result);
...
// n+ 최소한 1개 이상
str = "Hellooo";
patt = /o+/g;  //o문자가 하나이상 연속응로 있는 부분을 의미
...
// 전화번호
//010-2312-3354
patt = /^(010)-\d{4}-\d{4}$/;  //^는 문자열의 시작, (010)와 -는 문자 그대로, \d{4}는 숫자가 4개 연속으로 나오는것, $는 문자열의 끝
