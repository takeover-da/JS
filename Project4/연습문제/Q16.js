...
const sortedVidits = visits.sort((a, b) => new Date(a.date) - new Date(b.date));
console.log("정렬된 방문 기록:", sortedVidits);

// 방문 목적 기준으로 필터링
const filteredVisits = sortedVidits.filter((visit) => visit.purpose === "회의");
